...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, anchors=(), ch=(), key_point_nums = 8):  # detection layer
        super(Detect, self).__init__()
        self.nc = nc  # number of classes
        self.key_point_nums = key_point_nums   # key_point_nums = key_point_coordinate * 2
        self.no = nc + 5 + self.key_point_nums # number of outputs per anchor
